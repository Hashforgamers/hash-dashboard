...
import {
  ...
  LayoutGrid, Table as TableIcon, IndianRupee, Lock,
} from 'lucide-react'
      ...
      <div className="flex flex-col items-center gap-3 text-center px-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1 max-w-[250px]">
            Subscribe to manage extra services and menu items.
          </p>
        </div>
        <button
...
export default function ManageExtraServices() {
  ...
  /* ---------------------------------------------------------------
     SSR GUARD — same relative wrapper so lock works during hydration
  --------------------------------------------------------------- */
  if (!isClient) {
    return (
      <div className="relative w-full min-h-full">
        {isLocked && <LockedOverlay />}
        <div className={cn("page-container section-spacing", isLocked && "pointer-events-none select-none blur-sm")}>
  ...
  return (
    ...
    <div className="relative w-full min-h-full">
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className={cn("page-container section-spacing", isLocked && "pointer-events-none select-none blur-sm")}
      >
        {/* ✅ Page Header */}
        <motion.div
