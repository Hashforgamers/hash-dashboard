...
import { ShoppingCart, Package, Loader2, CheckCircle, X, Lock } from 'lucide-react'
      ...
      <div className="flex flex-col items-center gap-3 text-center px-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1 max-w-[250px]">
            Subscribe to view and place vendor orders.
          </p>
        </div>
        <button
...
const VendorOrderPage: React.FC = () => {
  ...
  // Loading state to prevent flash of content before checking subscription
  ...
  return (
    ...
    <div className="relative w-full min-h-full">
      ...
      {/* Show overlay if unsubscribed */}
      {isLocked && <LockedOverlay />}

      {/* Main Content wrapper with blur & disable logic if locked */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className={cn("page-container relative", isLocked && "pointer-events-none select-none blur-sm")}
      >
        {/* ---------- HEADER ---------- */}
        <motion.div
