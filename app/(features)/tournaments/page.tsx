...
export default function TournamentsPage() {
  ...
  // ── Guards ────────────────────────────────────────────
  if (tokenLoading || isSubscriptionLoading) return (
    <DashboardLayout>
  ...
  return (
    <DashboardLayout>
      ...
      <div className="relative w-full min-h-full flex flex-col flex-1">
        ...
        <div className={cn("page-container flex-1", isLocked && "pointer-events-none select-none blur-sm")} onClick={() => setOpenMenuId(null)}>
