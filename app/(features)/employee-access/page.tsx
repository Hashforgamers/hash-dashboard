...
const SERVICE_PERMISSION_MAP: Array<{
  ...
  { label: "Cafe Wallet Top-ups & Shifts", permission: "wallet.topup", section: "Operations" },
  { label: "Cafe Wallet Reversals", permission: "wallet.refund", section: "Admin" },
  { label: "Cafe Wallet Adjustments", permission: "wallet.adjust", section: "Admin" },
