    ...
    <DashboardLayout contentScroll="contained">
      <div className="flex h-full min-h-0 flex-col gap-4 overflow-hidden">
        ...
        <Tabs defaultValue="add-employee" className="flex min-h-0 flex-1 flex-col overflow-hidden">
          <TabsList className="gaming-panel h-auto w-fit shrink-0 gap-1 rounded-xl border border-cyan-500/25 bg-slate-900/50 p-1">
            <TabsTrigger
              value="add-employee"
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-hidden rounded-xl border border-cyan-500/25 bg-slate-900/40">
              <div className="grid grid-cols-12 border-b border-cyan-500/20 px-3 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-slate-400">
              ...
              <div className="h-full overflow-y-auto">
                {staffProfiles.length === 0 ? (
                  ...
                  staffProfiles.map((staff) => (
                    <div
                      key={staff.id}
                      className="grid grid-cols-12 items-center border-b border-slate-800/70 px-3 py-2 text-sm text-slate-200"
                    >
                      <div className="col-span-4 flex items-center gap-2 truncate font-medium">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-3">
              {Object.entries(serviceSections).map(([section, items]) => (
                <div key={section} className="mb-4 rounded-lg border border-slate-700/80 bg-slate-950/50">
                  ...
                  <div className="grid grid-cols-12 border-b border-slate-700/60 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-400">
